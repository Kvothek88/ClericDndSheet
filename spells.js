...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const spellsStatus = [
        ...
        {name: 'herowsfeast', active: false, concentration: false, duration: true, level: 6, verbal: true, somatic: true, castingTime: '10 minutes', range: 'Touch', saveDC: '-', effectType: 'Buff'},
        ...
        {name: 'dispelmagiclevel6', active: false, concentration: false, duration: false, level: 6, verbal: true, somatic: true, castingTime: '1 Action', range: '60 ft', saveDC: '-', effectType: 'Control'},
